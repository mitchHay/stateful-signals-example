...
export class HomePageComponent {
  ...
  readonly $welcomeMessageSubject: Subject<boolean | void> = new Subject();
  ...
  constructor(private loadingService: LoadingService) {
    this.welcomeMessage = new StatefulSignal(this.$welcomeMessageSubject);
  ...
  onFetchWelcomeMessage(): void {
    ...
    this.$welcomeMessageSubject.next(shouldThrowError);
  }
